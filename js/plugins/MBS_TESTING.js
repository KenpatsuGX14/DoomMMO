...
(function ($) {
	...
	Scene_Base.prototype.update = function() {
		...
		if (this.isMobileDevice() && this._cButton != undefined)
			this._cButton.visible;
	};
...
Imported["MBS_TESTING"] = 1.1;

if (Imported["MVCommons"]) {
  	PluginManager.register("MBS_TESTING", 1.1, "Shows a DirPad and action buttons when using mobile devices", {  
